...
public class Usuario {
    ...
    @Column(name = "correo_electronico", length = 20, nullable = false, unique = false)
    private String correoElectronico;
    @Column(name = "contraseña", length = 20, nullable = false, unique = false)
    private String contraseña;
    @Column(name = "telefono", length = 20, nullable = false, unique = false)
    private String telefono;

    @Column(name = "TipoUsuario", length = 20, nullable = false, unique = false)
